...
namespace Fujitsu.AFC.UnitTesting
{
    ...
    public class UnitTestHelper
    {
        ...
        public static T GenerateRandomData<T>(Action<T> postGenerateAction)
        {
            ...
            postGenerateAction?.Invoke(response);
