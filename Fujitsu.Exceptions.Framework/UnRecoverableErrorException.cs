...
{
    [Serializable]
    public class UnRecoverableErrorException : Exception
    {
        public static int DefaultRetryInterval = 5000;
        public static int DefaultRetryAttempts = 0;

        /// <summary>
        /// Initializes a new instance of the UnRecoverableErrorException class.
        /// </summary>
        public UnRecoverableErrorException()
            : base("A unrecoverable error occurred")
        {
        }
        ...
        /// <summary>
        ///    Initializes a new instance of the UnRecoverableErrorException class with a specified
        ...
        public UnRecoverableErrorException(string message, Exception innerException)
        ...
        /// </summary>
        public virtual bool ShouldRetry => true;
        ...
        /// before aborting.
        /// </summary>
        public virtual int MaxRetries => DefaultRetryAttempts;
    }
}
